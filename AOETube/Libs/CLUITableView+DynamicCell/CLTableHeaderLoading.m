...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.indicatorView centerInView:self];
...
- (void)layoutSubviews
{
    ...
    [self.indicatorView centerInView:self];
    [self.indicatorView centerInView:[[[[UIApplication sharedApplication] keyWindow] subviews] lastObject] onAxis:NSLayoutAttributeCenterX];
    
    NSLog(@"indicator : %@", self.indicatorView);
